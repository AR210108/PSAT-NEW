...
@section('content')
    ...
    <div class="container py-4">
        <div class="card shadow border-0" style="background-color: #2d2c2c; color: white;">
            <div class="card-body">
                ...
                <!-- Form pencarian dan filter data siswa -->
                <form method="GET" action="{{ url('/siswa') }}" class="row gy-2 gx-3 mb-4 align-items-end">
                    <!-- Input nama atau NIS -->
                    <div class="col-md-4">
                        <input type="text" name="search" id="search" class="form-control"
                            value="{{ request('search') }}" placeholder="Masukkan nama atau NIS"
                            style="border-radius: 28px;">
                    </div>
                    <!-- Filter jenjang -->
                    <div class="col-md-2">
                        <select name="jenjang" id="jenjang" class="form-select" style="border-radius: 28px;">
                    ...
                    <!-- Filter jurusan -->
                    <div class="col-md-2">
                        <select name="jurusan" id="jurusan" class="form-select" style="border-radius: 28px;">
                    ...
                    <!-- Filter kelas -->
                    <div class="col-md-2">
                        <select name="kelas" id="kelas" class="form-select" style="border-radius: 28px;">
    ...
    <!-- Script untuk filter kelas dan popup -->
